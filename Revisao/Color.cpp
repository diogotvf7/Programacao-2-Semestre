...
bool Color::equal_to(const Color& other) const {return (red_ == other.red() && green_ == other.green() && blue_ == other.blue());}
void Color::invert() {red_ = 255 - red_; green_ = 255 - green_; blue_ = 255 - blue_;}